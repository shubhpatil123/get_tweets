...
if __name__ == '__main__':
    ...
    tweets = api.user_timeline(screen_name="narendramodi", count=10, tweet_mode="extended")
...
#    print("writing to " + outfile)
    ...
    print('--------------new edit here -----------------')
    print(tmp)
    t_dict=tweet_analyzer.get_tweets(tmp)
    print(t_dict)
    print(len(tmp))
    ptweets = [tweet for tweet in t_dict if t_dict['sentiment'] == 'positive'] 
    # percentage of positive tweets
    print(ptweets)
    print("Positive tweets percentage: {} %".format(100*len(ptweets)/len(tmp))) 
    # picking negative tweets from tweets 
    ntweets = [tweet for tweet in t_dict if t_dict['sentiment'] == 'negative'] 
